var tweets = [
    ...
    "The Federal Reserve is totally politicized. They donâ€™t really care about the dollar. They care more about inflation than they do about the economy. In other words the Fed is the enemy of the people. The Fed is absolutely killing us. We need a real Federal Reserve that is much more flexible than the Fed itself. We need some Fed that is much less aggressive than the Fed. We need some Fed that is much more flexible than the Fed. We need some Federal Reserve that is much less aggressive than the Fed. We need some Fed that is much less aggressive than the Fed. We need some Fed that is much more flexible than the Fed. We need some Fed that is much more flexible than the Fed. We need more than 100.",
